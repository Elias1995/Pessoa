...
public class TelaFuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel21.setText("Campo não preenchido!");
        ...
        jLabel6.setText("Universidade:");

        jTextField6.setEditable(false);
        jTextField6.setText("Veiga de Almeida");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Endereço Residencial"));

        jLabel7.setText("Logradouro:");

        jLabel8.setText("Tipo de Logradouro:");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Local de Trabalho"));

        jLabel14.setText("Logradouro:");

        jLabel15.setText("Tipo de Logradouro:");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextField13, javax.swing.GroupLayout.PREFERRED_SIZE, 398, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        funcionario1.setNome(jTextField1.getText());
        funcionario1.setMatricula(jTextField2.getText());
        funcionario1.setFuncao(jTextField4.getText());
        funcionario1.setSalario(Float.valueOf(jTextField3.getText()));
        funcionario1.setAnoInicio(Integer.valueOf(jTextField5.getText()));
        funcionario1.enderecoResidencial.setLogradouro(jTextField7.getText());
        funcionario1.enderecoResidencial.setTipoLogradouro(jTextField8.getText());
        funcionario1.enderecoResidencial.setComplemento(jTextField9.getText());
        funcionario1.enderecoResidencial.setBairro(jTextField10.getText());
        funcionario1.enderecoResidencial.setCidade(jTextField11.getText());
        funcionario1.enderecoResidencial.setEstado(jTextField12.getText());
        funcionario1.enderecoResidencial.setCEP(Integer.valueOf(jTextField19.getText()));
        funcionario1.localTrabalho.setLogradouro(jTextField13.getText());
        funcionario1.localTrabalho.setTipoLogradouro(jTextField14.getText());
        funcionario1.localTrabalho.setComplemento(jTextField15.getText());
        funcionario1.localTrabalho.setBairro(jTextField16.getText());
        funcionario1.localTrabalho.setCidade(jTextField17.getText());
        funcionario1.localTrabalho.setEstado(jTextField18.getText());
        funcionario1.localTrabalho.setCEP(Integer.valueOf(jTextField20.getText()));
        
        funcionario1.armazenar();
